  ...
  return(
    ...
    <form onSubmit={ props.createNewFish }>
        ...
        <fieldset className="form-group">
          <label>name</label>
          <input onChange={props.onNameChange} value={props.name} type="text" className="form-group"/>
        </fieldset>
        <fieldset className="form-group">
          <label>color</label>
        ...
        <fieldset className="form-group">
          ...
          <select onChange={props.onPeopleEaterChange} value={props.people_eater} className="form-control">
